...
// let newStudentArray = students.slice(3,11);

// while (count < newStudentArray.length) {
//   console.log(newStudentArray[count]);
//   count++;
// }
...
// while (count <= 10) {
//   console.log(newnewstudentarray.concat(students)[count]);
//   count++;
  
// }

// OR ALTERNATIVE METHOD BELOW:

// count = 0;
// let newNewStudentArray = students.slice(3,11);
